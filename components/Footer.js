    ...
    <div>
      <footer className="text-gray-600 body-font bg-blue-50">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:ml-24 mx-auto text-center md:text-left">
            <Link href={"/"}>
              <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
              <Image src="/mainlogo.png" alt="" width={200} height={50}/>
              </a>
            </Link>
            <p className="mt-2 text-sm text-gray-500 px-2">Wear the &lt;code/&gt;
            <br/> Premium coding tshirts, hoodies and apparals</p>
          </div>
        ...
        <div className="bg-slate-200">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-500 text-sm text-center sm:text-left">© 2022 &lt;GeeksWear./&gt;. All rights reserved
            </p>
